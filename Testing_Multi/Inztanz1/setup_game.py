...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Magic_Shapes.py"

        #Name of program
        self.project_name = "Magic_Shapes"
        ...
        self.author_email = "gqdeltex@gmail.com"
        self.copyright = "Copyright (c) 2016 Peter Setngl."

        #Description
        self.project_description = "This Game was made for Ludum Dare 35 and is continued"
